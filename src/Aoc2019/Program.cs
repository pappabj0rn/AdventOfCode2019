...
namespace Aoc2019
{
    ...
    {
        private static string Prg1202Key = "1202 program";
        private static string ModuleWeightKey = "ModuleWeights";
        private static string CrossedWireDataKey = "Crossed Wire Data";
        private static string PasswordDataKey = "Pwd Data";
        ...
        private static Dictionary<string,object> LoadData()
        {
            ...
            var pwdData = new[] {165432, 707912};

            var data = new Dictionary<string, object>
            {
                {ModuleWeightKey, moduleWeights},
                {Prg1202Key, prg1202},
                {CrossedWireDataKey, wireData},
                {PasswordDataKey, pwdData}
            };

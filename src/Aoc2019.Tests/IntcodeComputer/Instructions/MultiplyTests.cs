...
{
    public abstract class MultiplyTests : InstructionTestBase
    {
        ...
        public class Execute : MultiplyTests
        {
            [Fact]
            public void Should_in_addr_mode_multiply_values_at_addr1_and_addr2_and_write_to_addr3()
            {
                var in1 = 3;
                var in2 = 7;
